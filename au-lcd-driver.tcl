...
#
# au-lcd-driver.tcl: Tcl script for re-creating project 'au-lcd-driver'
#
...
set _xil_proj_name_ "au-lcd-driver"
...
set script_file "au-lcd-driver.tcl"
...
# Create project
create_project ${_xil_proj_name_} $origin_dir/vivado_project -part xc7a35tftg256-1 -quiet -force
...
set_property -name "top" -value "maincore" -objects $obj
...
set file "[file normalize "$origin_dir/src/constraints/au.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/src/constraints/au.xdc"
set file [file normalize $file]
...
set obj [get_filesets sim_1]
set_property -name "top" -value "maincore_tb" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a35tftg256-1 -flow {Vivado Synthesis 2023} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a35tftg256-1 -flow {Vivado Implementation 2023} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
